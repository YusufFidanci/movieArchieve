...
return (
    <div style={styles.main}>
      ...
      <div style={styles.listSection}>
        {directors.map((d, i) => (
          <Link key={d.directorID} to={`/directors/${d.directorID}`} style={{...styles.listRow, textDecoration: "none"}}>
            <div style={styles.listInfo}>
              <div style={styles.listTitle}>{d.fullName}</div>
            </div>
  </Link>
))}
      </div>
