...
return (
    <div style={styles.main}>
      <p style={styles.sectionTitle}>Movies</p>
      <div style={styles.listSection}>
        {movies.map((m, i) => (
          <Link key={m.movieID} to={`/movies/${m.movieID}`} style={{...styles.listRow, textDecoration: "none"}}>
            <div style={styles.listInfo}>
              <div style={styles.listTitle}>{m.title}</div>
              <div style={styles.listSub}>{m.releaseYear}</div>
            </div>
  </Link>
))}
      </div>
